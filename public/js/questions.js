...
$(document).ready(function() {
      ...
      var answer_form = '<form action="questions/<%= @question.id %>/comment/new" method="post" ><input id="authorName" type="text" name="author_name" placeholder="Username"><textarea rows="10" cols="30" name="comment" placeholder="Comment"></textarea><input type="submit" value="Post Answer"></form>';
